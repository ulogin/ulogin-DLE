...
9. Зайти в Админцентр - Настройки системы - Настройки пользователей (для DLE 10.x Настройка системы - Посетители)
...
10. Провереть в настройках php опцию allow_url_fopen (должна быть включена) или наличия расширения curl.
...
- Добавлена проверка file_get_contents.